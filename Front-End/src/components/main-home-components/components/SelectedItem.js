...
class SelectedItem extends Component {
    ...
    handleRatingChange = (event) =>{
        ...
        this.state.rating = event;

    };

    async postData() {
        try {
            let result = await fetch("http://localhost:3000/product/addItemReview/", {
                method: "post",
                headers: {
    ...
    handleReviews = (id) =>{
        ...
        fetch('http://localhost:3000/product/getItemReview/'+id)
            .then(res => res.json())
            .then(json =>{
                            ...
                            <div className="col-lg-8 product-details" key={selectedProduct._id}>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    />
                                                    <br/>
                                                    <div className="p-rating rate-popup" >
                                                        <label htmlFor="exampleFormControlTextarea1">Rate Us</label>
                                                        <ReactStars
                                                            size={50}
                                                            half={false}
                                                            onChange={newRating => (
                                ...
                                <div id="accordion" className="accordion-area">
                                    ...
                                    <div className="panel" onClick={this.handleReviews.bind(this,selectedProduct._id)}>
                                        ...
                                        <div id="collapse2" className="collapse reviewStyle" aria-labelledby="headingTwo"
                                             data-parent="#accordion" >
                                            <div className="panel-body">
